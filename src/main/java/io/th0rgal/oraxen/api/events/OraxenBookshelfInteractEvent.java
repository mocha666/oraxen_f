...
public class OraxenBookshelfInteractEvent extends Event implements Cancellable {
    ...
    public OraxenBookshelfInteractEvent(BookshelfMechanic mechanic, Block block, BlockFace blockFace, Player player, ItemStack itemInHand, EquipmentSlot hand) {
    ...
    /**
     * @return The item in hand when the player interacted with the Chiseled Bookshelf
     */
